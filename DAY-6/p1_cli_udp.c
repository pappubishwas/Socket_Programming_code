...
int main()
{
    ...
    while (1)
    {
        ...
        if (choice == 1)
        {
            ...
            if (sendto(client_fd, command, strlen(command), 0, (struct sockaddr *)&server_addr, sizeof(server_addr)) == -1)
            {
            ...
            if (sendto(client_fd, &student, sizeof(StudentInfo), 0, (struct sockaddr *)&server_addr, sizeof(server_addr)) == -1)
            {
            ...
            ssize_t bytes_received = recvfrom(client_fd, buffer, sizeof(buffer), 0, (struct sockaddr *)&server_addr, &server_len);
            if (bytes_received == -1)
            {
        ...
        else if (choice == 2)
        {
            ...
            sendto(client_fd, username, strlen(username), 0, (struct sockaddr *)&server_addr, sizeof(server_addr));
            sendto(client_fd, password, strlen(password), 0, (struct sockaddr *)&server_addr, sizeof(server_addr));
            ...
            if (strcmp(buffer, "Authentication successful") == 0)
            {
                ...
                if (sendto(client_fd, studentRoll, strlen(studentRoll), 0, (struct sockaddr *)&server_addr, sizeof(server_addr)) == -1)
                {
                ...
                memset(buffer, 0, sizeof(buffer));
                socklen_t server_len = sizeof(server_addr);
                bytes_received = recvfrom(client_fd, buffer, sizeof(buffer), 0, (struct sockaddr *)&server_addr, &server_len);
                if (bytes_received == -1)
                {
                    perror("Receiving response failed");
                    exit(EXIT_FAILURE);
                ...
                else
                {
                    ...
                    memset(buffer, 0, sizeof(buffer));
                    socklen_t server_len = sizeof(server_addr);
                    bytes_received = recvfrom(client_fd, &student, sizeof(StudentIn), 0, (struct sockaddr *)&server_addr, &server_len);
                    if (bytes_received == -1)
                    {
